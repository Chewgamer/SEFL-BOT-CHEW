...
settings = {
    ...
    "welcome":"[สวัสดีคนไทยที่ไปซื้อลำใยนอกโลกด้วยนะครับ]",
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "u5505062dc6c92cd558efd74fc86cb878")
...
#===================================================================#              
                  ...
                  if msg._from in admin: 
                	...
                	if msg.toType == 2:
                         _name = msg.text.replace(".ไป","")
                         gs = line.getGroup(receiver)
                         line.sendMessage(receiver,"SEE YOU AGAIN ")
                         targets = []
                         for g in gs.members:
